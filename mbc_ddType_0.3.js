jQuery.mbc_ddType = function( settings ) {
 ...
 onLoad();
   function onLoad() {
		...
		//-------------------end ----------------//
		var containerstring = "<div class='stLoading'><h1>Loading items...</h1></div><div id='container' class='col-4'><div class='header' style='flex-basis:99.8%'><div class='question'>If this menu were available<b>what you would buy?</b>(Menu 1 of 4)<br><strong>PURCHASE OCCASION:</strong>Next morning purchase (before 11am) buying for<strong>x people</strong>, including yourself.<br></div><div class='menu-sequence'>MENU #<label class='order'>1</label><label class='total'> of "+settings.menu_max+"</label></div><div class='hoverinstruction' style='text-align:center'><i class='fa fa-info-circle fa-2x'></i> Roll over the <i class='fa fa-info-circle'></i> icon next to an item for description</div></div><div class='cell table-column column-1'><div class='category' data-group='COFFEE'><div class='menu-header'><span>"+settings.headerText["1"]+"</span><span>Hot | Iced</span></div></div><div class='category' data-group='ESPRESSO'><div class='menu-header'>"+settings.headerText["2"]+"</div></div></div><div class='cell table-column column-2'><div class='category' data-group='REFRESHING_SIPS'><div class='menu-header'><span>"+settings.headerText["3"]+"</span><span>Hot | Iced</span></div></div></div><div class='cell table-column column-3'><div class='category' data-group='EATS'><div class='menu-header'>"+settings.headerText["4"]+"</div></div></div><div class='cell table-column column-4'><div class='category' data-group='SNACKIN'><div class='menu-header'>"+settings.headerText["5"]+"</div></div><div class='category' data-group='BAKERY'><div class='menu-header'>"+settings.headerText["6"]+"</div></div></div><div class='footer' style='flex-basis:97.98%'><div style='flex-basis:25%;background-color:#e0e6f4;padding:5px;height:55px'><div class='tbl'><div class='totallabel'>TOTAL:</div><div class='total' style='font-size:15pt'>$0.00</div><div class='totalimage'><img src='https://ssiprojects.s3.amazonaws.com/rnd/tools/mbc/mbc_ddType/machine.png' height='50'></div></div></div><div style='flex-basis:75%;background-color:#e0e6f4;padding:5px;height:55px'><div class='tbl'><div class='freqText'>Earlier you said you would purchase from Brand x times in the morning. If this menu replaced the current menu, how many times would you purchase in the next 30 days. Please assume you like the taste of any items you choose from this menu</div><div class='freqAnswer'><input autocomplete='off' type='text' min='0' max='30' value='' style='width:50px;height:30px'></div></div></div></div><div class='btn left disabled' value='1' style='flex-basis:20%;background-color:#2f5597;margin-top:10px' data-html='true' data-placement='top' title='Please select at lease one response.'>CONTINUE</div></div>"
		//-------------------build table----------------//
		...
		new AutoNumeric("input[type='text']",{
				decimalPlaces: 0,
				maximumValue: "30",
				minimumValue: "0"
		});
